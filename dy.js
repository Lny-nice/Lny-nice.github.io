const wsurl = "ws://1.14.17.81:3000";
var ws = null;
...
// 	console.log('-----------------user-----------------', user)
    let msg = {
        ...
        user_is_admin: "y",//user.user_attr.is_admin ? "y" : "n",
        user_is_super_admin: "y" //user.user_attr.is_super_admin ? "y" : "n", // 超级管理员
    };
...
function init() {
    ...
    ws.onopen = () => {
        ...
        console.log("- 欢迎加入 roomJoinDom", roomJoinDom);
        chatObserverrom.observe(chatDom, { childList: true });
        console.log("- 欢迎加入 chatDom", chatDom);
    };
